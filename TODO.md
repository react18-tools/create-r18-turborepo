...
- [ ] 🌟 Enable [private vulnerability reporting](https://github.com/react18-tools/create-r18-turborepo/security)
- [ ] Set up `CodeCov`
...
- [ ] Set up GitHub pages to deploy docs
  - Go to [repo settings](https://github.com/react18-tools/create-r18-turborepo/settings/pages) -> pages (On the left panel); Select deploy from a branch; Then Select `main` and `/docs`
